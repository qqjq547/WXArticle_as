...
public class DetailActivity extends BaseActivity {
	...
	public void onClick(View v) {
		...
		case R.id.detail_share:
			share = new ShareUtil(this, juhe.getTitle(), juhe.getUrl());
			share.show();
			break;
		...
		case R.id.detail_comment:
			if (juhe != null) {
				...
				intent.putExtra("juhe", juhe);
				startActivity(intent);
			} else {
				showShortToast(R.string.detail_getdata_failed);
			}
			break;
		case R.id.showedit:
		...
		case R.id.sendimg:
			...
			if (TextUtils.isEmpty(content)) {
				showShortToast(R.string.detail_comment_empty);
			} else {
				if (user == null) {
					...
					comment.save(this, new SaveListener() {
						...
						public void onSuccess() {
							...
							juhe.update(DetailActivity.this, new UpdateListener() {
	...
	private void InitJuhe() {
		...
		query.addWhereEqualTo("id", juhe.getId());
		query.findObjects(this, new FindListener<Juhe>() {
			@Override
			public void onSuccess(List<Juhe> arg0) {
				// TODO Auto-generated method stub
				if (arg0 != null && arg0.size() > 0) {
					juhe = arg0.get(0);
					LogUtil.e(juhe.toString());
					juhe.getComments(DetailActivity.this, new FindListener<Comment>() {
						@Override
					...
					juhe.getCollectByData(DetailActivity.this, new FindListener<MyUser>() {
					...
					juhe.getLike(DetailActivity.this, new FindListener<MyUser>() {
			...
			if (juhe == null) {
				...
				juhe.getCollectByData(DetailActivity.this, new FindListener<MyUser>() {
					...
					public void onSuccess(List<MyUser> users) {
						...
						user.addJuheCollect(DetailActivity.this, juhe, new UpdateListener() {
							@Override
							public void onSuccess() {
								// TODO Auto-generated method stub
								juhe.addCollectData(DetailActivity.this, user, new UpdateListener() {
									@Override
									public void onSuccess() {
										// TODO Auto-generated method stub
										isCollect = !isCollect;
	...
	private void like() {
		...
		if (user == null) {
			...
			if (juhe == null) {
				...
				if (user.islikeJuhe(juhe)) {
					showShortToast(R.string.detail_already_like);
				} else {
					juhe.addLikeData(this, user, new UpdateListener() {
						@Override
						public void onSuccess() {
							// TODO Auto-generated method stub
							likenum++;

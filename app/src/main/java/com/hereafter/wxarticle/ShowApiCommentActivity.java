...
public class ShowApiCommentActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mAdapter = new CommentAdapter(ShowApiCommentActivity.this, commentArr);
		listview.setAdapter(mAdapter);
		getListData();
	}

	private void getListData() {
		mshow.getComments(this, new FindListener<Comment>() {
				...
				if (TextUtils.isEmpty(content)) {
					...
					comment.save(this, new SaveListener() {
						...
						public void onSuccess() {
							...
							mshow.update(ShowApiCommentActivity.this, new UpdateListener() {
